...
public interface DepartmentService {
	 ...
	 * @throws Exception - SQL 처리에 실패한 경우
	 */
	public Department editDeptnoDepartment(Department params)
			throws NullPointerException, Exception;

	public Department editDnameDepartment(Department params)
			throws NullPointerException, Exception;
	
	public Department editLocDepartment(Department params)
			throws NullPointerException, Exception;
