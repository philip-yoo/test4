...
<%
	...
	Logger logger = LogManager.getFormatterLogger("prof_update_comm.jsp");
...
<body>
	<div class="container">
		<h1 class="page-header">교수수정</h1>
			<form name="myform" method="post" action="prof_update_comm_save.jsp?profno=<%=item.getProfno()%>" role="form">
			
				<div style="font-size:20px; font-weight:bold;"> 기존 보직수당(만원) : <%=item.getPosition() %></div>
				<br>
				<div class="form-group">
					<label for="comm">변경할 보직수당(만원)</label>
