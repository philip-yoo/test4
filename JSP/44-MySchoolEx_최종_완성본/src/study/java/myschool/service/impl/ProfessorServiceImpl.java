...
public class ProfessorServiceImpl implements ProfessorService {
	...
	/** 교수 수정하기 -> 수정된 결과를 조회하여 리턴한다. */
	@Override
	public Professor editProfnoProfessor(Professor params) throws NullPointerException, Exception {
		int row_count = session.update("ProfessorMapper.edit_profno_professor", params);
	...
	@Override
	public Professor editDeptnoProfessor(Professor params) throws NullPointerException, Exception {
		int row_count = session.update("ProfessorMapper.edit_deptno_professor", params);
	...
	@Override
	public Professor editPositionProfessor(Professor params) throws NullPointerException, Exception {
		int row_count = session.update("ProfessorMapper.edit_position_professor", params);
	...
	@Override
	public Professor editSalProfessor(Professor params) throws NullPointerException, Exception {
		int row_count = session.update("ProfessorMapper.edit_sal_professor", params);
	...
	@Override
	public Professor editCommProfessor(Professor params) throws NullPointerException, Exception {
		int row_count = session.update("ProfessorMapper.edit_comm_professor", params);
