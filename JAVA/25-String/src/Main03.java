public class Main03 {
	public static void main(String[] args) {
		...
		// 태어난 년도의 판별
		if (gender_code.contentEquals("1") || gender_code.contentEquals("2")) {
			yy = "19" + yy;
		} else {
			yy = "20" + yy;
		}
		...
		if (gender_code.equals("2") || gender_code.contentEquals("4")) {
			gender = "여자";
		}
