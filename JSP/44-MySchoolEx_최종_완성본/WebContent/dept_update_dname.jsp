...
<body>
	<div class="container">
		<h1 class="page-header">학과수정</h1>
			<form name="myform" method="post" action="dept_update_dname_save.jsp?deptno=<%=item.getDeptno()%>" role="form">
			
				<div style="font-size:20px; font-weight:bold;"> 기존 학과명 : <%=item.getDname() %> </div>
				<br>
				<div class="form-group">
					<label for="dname">변경할 학과명</label>
