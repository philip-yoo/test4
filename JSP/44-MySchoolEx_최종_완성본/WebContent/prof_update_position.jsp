...
<body>
	<div class="container">
		<h1 class="page-header">교수수정</h1>
			<form name="myform" method="post" action="prof_update_position_save.jsp?profno=<%=item.getProfno()%>" role="form">
			
				<div style="font-size:20px; font-weight:bold;"> 기존 보직 : <%=item.getPosition() %></div>
				<br>
				<div class="form-group">
					<label for="position">변경할 보직</label>
