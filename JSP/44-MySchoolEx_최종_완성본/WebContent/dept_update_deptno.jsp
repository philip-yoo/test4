...
<%
	...
	Logger logger = LogManager.getFormatterLogger("dept_update_deptno.jsp");
...
<body>
	<div class="container">
		<h1 class="page-header">학과수정</h1>
			<form name="myform" method="post" action="dept_update_deptno_save.jsp?dname=<%=item.getDname()%>" role="form">
			
				<div style="font-size:20px; font-weight:bold;"> 기존 학과번호 : <%=deptno %> (학생이 배정되어있는 학과는 학과번호 변경불가)</div>
				<br>
				<div class="form-group">
					<label for="deptno">변경할 학과번호</label>
