...
public class DepartmentServiceImpl implements DepartmentService {
	...
	/** 학과 수정하기 -> 수정된 결과를 조회하여 리턴한다. */
	
	@Override
	public Department editDeptnoDepartment(Department params) throws NullPointerException, Exception {
		int row_count = session.update("DepartmentMapper.edit_deptno_department", params);
	...
	@Override
	public Department editDnameDepartment(Department params) throws NullPointerException, Exception 
	{		
		int row_count = session.update("DepartmentMapper.edit_dname_department", params);
	...
	@Override
	public Department editLocDepartment(Department params) throws NullPointerException, Exception {
		int row_count = session.update("DepartmentMapper.edit_loc_department", params);
