...
public interface ProfessorService {
	 ...
	 * @throws Exception - SQL 처리에 실패한 경우
	 */
	public Professor editProfnoProfessor(Professor params)
			throws NullPointerException, Exception;

	public Professor editDeptnoProfessor(Professor params)
			throws NullPointerException, Exception;
	
	public Professor editPositionProfessor(Professor params)
			throws NullPointerException, Exception;
	
	public Professor editSalProfessor(Professor params)
			throws NullPointerException, Exception;
	
	public Professor editCommProfessor(Professor params)
			throws NullPointerException, Exception;
