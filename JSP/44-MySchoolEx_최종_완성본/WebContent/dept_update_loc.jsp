...
<body>
	<div class="container">
		<h1 class="page-header">학과수정</h1>
			<form name="myform" method="post" action="dept_update_loc_save.jsp?deptno=<%=item.getDeptno()%>" role="form">
			
				<div style="font-size:20px; font-weight:bold;"> 기존 장소 : <%=item.getLoc() %> </div>
				<br>
				<div class="form-group">
					<label for="loc">변경할 장소</label>
