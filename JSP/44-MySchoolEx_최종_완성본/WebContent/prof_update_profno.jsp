...
<%
	...
	Logger logger = LogManager.getFormatterLogger("prof_update_profno.jsp");
...
<body>
	<div class="container">
		<h1 class="page-header">교수수정</h1>
			<form name="myform" method="post" action="prof_update_profno_save.jsp?name=<%=item.getName()%>" role="form">
			
				<div style="font-size:20px; font-weight:bold;"> 기존 교수번호 : <%=profno %> (학생이 배정되어있는 교수는 교수번호 변경불가)</div>
				<br>
				<div class="form-group">
					<label for="profno">변경할 교수번호</label>
				...
				<ul class="list-group">
					...
					<li class="list-group-item"> 월급(만원) : <%=item.getSal()%> </li>
